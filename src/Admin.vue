        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-12">   
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="firstname" id="title" v-model="title">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                <label for="e">Content</label>
                <textarea name="content"  class="form-control" id="content" cols="30" rows="7" v-model="content"></textarea>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-4">
            ...
            <div class="form-group mt-3">
              <input type="file" @change="updatePreview($event)" ref="featured_image" name="" id="" class="form-control file">
            </div>
          </div>
          ...
          <div class="row p-3">
            ...
            <hr>
              ...
              <button @click.prevent="cancel()" class="btn btn-secondary float-right">Cancle</button>
            </div>
          </div>
      </form> 
    </div>
 ...
 export default {
  ...
  methods: {
    ...
    update () {
        ...
        //axios
        this.$api.post('/blog/update/' + this.post_id, form).then(res => {
    ...
    getPost (post_id, post_index) {
        ...
        this.$api.get('/blog/' + post_id).then(res => {
          ...
          let image = res.data.post_featured_image;
          if(image != ''){

            this.image = 'http://localhost/restapi/public/assets/uploads/' + image;
